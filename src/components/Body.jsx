  ...
  useEffect(() => {
    const getInitialPlaylist = async () => {
      ...
      const selectedPlaylist = {
        ...
        description : response.data.description.startsWith("<a") ? " " : response.data.description,    // kadhi kadhi <a tag sobat desc yet mhanun
                    ...
                    <div className="row" key={id} onClick={() => playTrack(id , name , artists , image , context_uri , track_number)} >
                      ...
                      <div className="col">
                        <span>{  
                          ...
                          "0"+Math.floor((duration/1000) % 60) :Math.floor((duration/1000) % 60) }
                        </span>
                      </div>
                    </div>
                  )
...
.playlist{
  ...
  .image{
    img{
      height: 15rem;
      box-shadow: rgba(0 , 0 , 0 , 025) 0px 25px 50px -12px;
    }
  }
